...
enum IROpcodes {
	...
	IR_CMSG_PLAYER_LOGOUT 			= 0x08,
	IR_SMSG_PLAYER_LOGOUT_RESP 		= 0x09,
	IR_SMSG_PLAYER_ENTER_BG			= 0x0A,
	IR_SMSG_PLAYER_LEAVE_BG			= 0x0B,
	IR_SMSG_SEND_SOCIAL_LIST		= 0x0C,
	
	IR_NUM_MSG_TYPES				= 0x0D,
};

struct IROpcodeHandler
{
    char const* name;
    void (InterRealmTunnel::*handler)(WorldPacket& recvPacket);
};
